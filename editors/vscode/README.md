...
VS Code extension for `.bcl` and `.schema` files. It provides TextMate highlighting, snippets, formatting, diagnostics, IntelliSense, hover, goto definition, references, rename, symbols, semantic tokens, and recent symbol history through `bcl-lsp`.
